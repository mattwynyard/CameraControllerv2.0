...
public class TCPServer {
    ...
    public void start() {
        try {
            ...
            accessWriter = new PrintWriter(client.getOutputStream());
            Runnable phoneThread = new AccessThread(String.valueOf(this.hasPhone));//access
            mReadAccessThread = new Thread(phoneThread);
    ...
    public void startMap() {
        try {
            ...
            mReadMapThread = new Thread(MapThread);
            if (!hasPhone) mReadMapThread.setPriority(Thread.MAX_PRIORITY);
    ...
    private final Runnable MapThread = new Runnable() {
        @Override
        public void run() {
    ...
    private class AccessThread implements Runnable {
        boolean phone;
        public AccessThread(Object o) {
            if (o.equals("true")) {
                this.phone = true;
